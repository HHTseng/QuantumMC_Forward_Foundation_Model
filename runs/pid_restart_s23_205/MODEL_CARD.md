...
- Residual negative log likelihood (standardized coordinates): -5.370006
- Reconstructed-PID cross entropy: 0.977840
- Reconstructed-PID top-1 accuracy: 67.9800%
- PID maximum marginal probability discrepancy: 0.1769%
- Worst fixed-bin conditional PID total-variation distance: 0.0268 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 98.9946%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1152%

One-dimensional sampled closure:

- pi- delta_p: W1=0.013932, mean difference=0.0066535, std ratio=0.9986
- pi- delta_theta: W1=0.0016607, mean difference=0.00052655, std ratio=1.0003
- pi- delta_phi: W1=0.014219, mean difference=0.0034701, std ratio=0.9570
- pi+ delta_p: W1=0.015933, mean difference=0.0084112, std ratio=1.0084
- pi+ delta_theta: W1=0.0010625, mean difference=0.00015729, std ratio=1.0048
- pi+ delta_phi: W1=0.015323, mean difference=0.0009287, std ratio=1.0118
- proton delta_p: W1=0.01002, mean difference=0.0059636, std ratio=0.9878
- proton delta_theta: W1=0.00059867, mean difference=0.00014509, std ratio=1.0097
- proton delta_phi: W1=0.0068112, mean difference=0.00070179, std ratio=0.9998
