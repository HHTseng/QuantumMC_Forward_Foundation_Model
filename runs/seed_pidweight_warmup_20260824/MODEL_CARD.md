...
- Residual negative log likelihood (standardized coordinates): -4.993504
- Reconstructed-PID cross entropy: 0.984208
- Reconstructed-PID top-1 accuracy: 67.8421%
- PID maximum marginal probability discrepancy: 0.1478%
- Worst fixed-bin conditional PID total-variation distance: 0.0243 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0174%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.0500%

One-dimensional sampled closure:

- pi- delta_p: W1=0.042639, mean difference=0.033425, std ratio=1.0135
- pi- delta_theta: W1=0.0019971, mean difference=0.0010316, std ratio=0.9999
- pi- delta_phi: W1=0.015996, mean difference=0.00085483, std ratio=0.9698
- pi+ delta_p: W1=0.077406, mean difference=0.071646, std ratio=1.0395
- pi+ delta_theta: W1=0.002155, mean difference=0.00066026, std ratio=1.0333
- pi+ delta_phi: W1=0.017838, mean difference=0.00017005, std ratio=1.0357
- proton delta_p: W1=0.058877, mean difference=0.056411, std ratio=1.0306
- proton delta_theta: W1=0.0027218, mean difference=0.0017275, std ratio=1.0402
- proton delta_phi: W1=0.016283, mean difference=0.0039833, std ratio=1.0696
