...
- Residual negative log likelihood (standardized coordinates): -5.320719
- Reconstructed-PID cross entropy: 0.979685
- Reconstructed-PID top-1 accuracy: 67.9586%
- PID maximum marginal probability discrepancy: 0.0938%
- Worst fixed-bin conditional PID total-variation distance: 0.0230 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1431%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1627%

One-dimensional sampled closure:

- pi- delta_p: W1=0.0092669, mean difference=0.0015507, std ratio=1.0017
- pi- delta_theta: W1=0.0011691, mean difference=0.00036207, std ratio=1.0038
- pi- delta_phi: W1=0.013141, mean difference=0.0087949, std ratio=0.9709
- pi+ delta_p: W1=0.012272, mean difference=0.0067985, std ratio=1.0055
- pi+ delta_theta: W1=0.00091121, mean difference=0.0001387, std ratio=1.0093
- pi+ delta_phi: W1=0.010941, mean difference=0.00018034, std ratio=0.9869
- proton delta_p: W1=0.0077697, mean difference=0.0034749, std ratio=1.0093
- proton delta_theta: W1=0.00066432, mean difference=0.00024821, std ratio=1.0182
- proton delta_phi: W1=0.0071696, mean difference=0.00047107, std ratio=0.9876
