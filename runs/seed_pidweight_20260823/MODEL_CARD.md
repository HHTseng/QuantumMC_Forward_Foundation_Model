...
- Residual negative log likelihood (standardized coordinates): -5.282008
- Reconstructed-PID cross entropy: 0.977864
- Reconstructed-PID top-1 accuracy: 67.9617%
- PID maximum marginal probability discrepancy: 0.1521%
- Worst fixed-bin conditional PID total-variation distance: 0.0313 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0243%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.0906%

One-dimensional sampled closure:

- pi- delta_p: W1=0.022579, mean difference=0.018875, std ratio=1.0085
- pi- delta_theta: W1=0.0014059, mean difference=0.00039484, std ratio=1.0013
- pi- delta_phi: W1=0.015872, mean difference=0.0039442, std ratio=0.9647
- pi+ delta_p: W1=0.03977, mean difference=0.034618, std ratio=1.0288
- pi+ delta_theta: W1=0.0014314, mean difference=0.00050118, std ratio=1.0071
- pi+ delta_phi: W1=0.013685, mean difference=0.00077045, std ratio=0.9995
- proton delta_p: W1=0.0083422, mean difference=0.0012133, std ratio=1.0018
- proton delta_theta: W1=0.00082087, mean difference=0.00033838, std ratio=1.0111
- proton delta_phi: W1=0.0081743, mean difference=0.00093915, std ratio=1.0043
