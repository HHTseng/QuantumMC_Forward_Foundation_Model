...
- Residual negative log likelihood (standardized coordinates): -5.816826
- Reconstructed-PID cross entropy: 0.977011
- Reconstructed-PID top-1 accuracy: 67.9901%
- PID maximum marginal probability discrepancy: 0.1628%
- Worst fixed-bin conditional PID total-variation distance: 0.0439 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 98.9198%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 98.9589%

One-dimensional sampled closure:

- pi- delta_p: W1=0.022725, mean difference=0.011287, std ratio=0.9939
- pi- delta_theta: W1=0.0017817, mean difference=0.00058308, std ratio=0.9869
- pi- delta_phi: W1=0.017485, mean difference=0.0044287, std ratio=0.9313
- pi- delta_beta: W1=0.0022242, mean difference=0.00056871, std ratio=0.9900
- pi+ delta_p: W1=0.015582, mean difference=0.00051761, std ratio=1.0011
- pi+ delta_theta: W1=0.0012204, mean difference=0.00043659, std ratio=0.9899
- pi+ delta_phi: W1=0.004812, mean difference=0.0018128, std ratio=1.0059
- pi+ delta_beta: W1=0.0033905, mean difference=5.4035e-05, std ratio=1.0129
- proton delta_p: W1=0.013488, mean difference=0.0036744, std ratio=0.9935
- proton delta_theta: W1=0.00075563, mean difference=0.00045668, std ratio=0.9983
- proton delta_phi: W1=0.0044499, mean difference=0.0012098, std ratio=1.0079
- proton delta_beta: W1=0.0022534, mean difference=0.00061378, std ratio=0.9802
...
- pi-: W1=0.0022091, mean difference=0.00056871, std ratio=0.9902, sampled in-domain=99.9345%
- pi+: W1=0.0034165, mean difference=5.4034e-05, std ratio=1.0131, sampled in-domain=99.8908%
- proton: W1=0.0018653, mean difference=0.00061378, std ratio=0.9942, sampled in-domain=99.9141%
