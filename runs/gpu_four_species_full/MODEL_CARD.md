...
- PID 11: 1,675,790 selected rows across 1,675,790 events
...
- Shared across configured generated PIDs [11, -211, 211, 2212] via a learned species embedding
- Periodic generated phi encoded as sine/cosine
- Joint reconstructed-PID categorical head
- Trainable parameters: 222,340
- Best validation epoch: 17

## Held-out test metrics

- Residual negative log likelihood (standardized coordinates): -5.162882
- Reconstructed-PID cross entropy: 0.489958
- Reconstructed-PID top-1 accuracy: 84.2498%
- PID maximum marginal probability discrepancy: 0.5211%
- Worst fixed-bin conditional PID total-variation distance: 0.0660 (proton, 6-7 GeV)
- Physical sampled `(p, theta)` fraction: 99.3381%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 98.9184%

One-dimensional sampled closure:

- electron delta_p: W1=0.014755, mean difference=0.00653, std ratio=1.0058
- electron delta_theta: W1=0.00025163, mean difference=2.7161e-05, std ratio=1.0290
- electron delta_phi: W1=0.0013623, mean difference=0.00062284, std ratio=1.0191
- pi- delta_p: W1=0.064631, mean difference=0.046043, std ratio=1.0132
- pi- delta_theta: W1=0.0032555, mean difference=0.0015629, std ratio=0.9886
- pi- delta_phi: W1=0.017914, mean difference=0.012374, std ratio=0.9415
- pi+ delta_p: W1=0.071976, mean difference=0.061524, std ratio=1.0224
- pi+ delta_theta: W1=0.0037332, mean difference=0.0026046, std ratio=1.0020
- pi+ delta_phi: W1=0.018882, mean difference=6.8906e-05, std ratio=1.0545
- proton delta_p: W1=0.027427, mean difference=0.013714, std ratio=1.0147
- proton delta_theta: W1=0.0022377, mean difference=0.0011335, std ratio=1.0021
- proton delta_phi: W1=0.017991, mean difference=0.0031465, std ratio=1.0847
