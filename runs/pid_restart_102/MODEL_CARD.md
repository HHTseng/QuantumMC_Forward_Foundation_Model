...
- Residual negative log likelihood (standardized coordinates): -5.709617
- Reconstructed-PID cross entropy: 0.718630
- Reconstructed-PID top-1 accuracy: 74.0428%
- PID maximum marginal probability discrepancy: 0.1757%
- Worst fixed-bin conditional PID total-variation distance: 0.0341 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1823%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1370%

One-dimensional sampled closure:

- pi- delta_p: W1=0.013822, mean difference=0.0022837, std ratio=1.0035
- pi- delta_theta: W1=0.0012504, mean difference=1.3955e-05, std ratio=0.9983
- pi- delta_phi: W1=0.014938, mean difference=0.0097301, std ratio=0.9569
- pi+ delta_p: W1=0.0082342, mean difference=0.0025072, std ratio=1.0016
- pi+ delta_theta: W1=0.00092296, mean difference=0.00012692, std ratio=0.9983
- pi+ delta_phi: W1=0.0048251, mean difference=0.0012459, std ratio=0.9670
- proton delta_p: W1=0.0080076, mean difference=0.0035879, std ratio=0.9980
- proton delta_theta: W1=0.00084163, mean difference=0.0004338, std ratio=1.0067
- proton delta_phi: W1=0.0052431, mean difference=0.00067211, std ratio=1.0074
