...
- Residual negative log likelihood (standardized coordinates): -5.355959
- Reconstructed-PID cross entropy: 0.977808
- Reconstructed-PID top-1 accuracy: 67.9851%
- PID maximum marginal probability discrepancy: 0.2017%
- Worst fixed-bin conditional PID total-variation distance: 0.0327 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0685%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1391%

One-dimensional sampled closure:

- pi- delta_p: W1=0.018193, mean difference=0.0094916, std ratio=1.0152
- pi- delta_theta: W1=0.0011861, mean difference=0.00084486, std ratio=1.0028
- pi- delta_phi: W1=0.0164, mean difference=0.0051579, std ratio=0.9581
- pi+ delta_p: W1=0.013501, mean difference=0.0033051, std ratio=1.0046
- pi+ delta_theta: W1=0.00081948, mean difference=0.00012103, std ratio=0.9993
- pi+ delta_phi: W1=0.012954, mean difference=0.0014216, std ratio=1.0124
- proton delta_p: W1=0.0065582, mean difference=0.00014409, std ratio=1.0041
- proton delta_theta: W1=0.00063649, mean difference=4.1836e-05, std ratio=1.0128
- proton delta_phi: W1=0.0081445, mean difference=0.0016448, std ratio=1.0072
