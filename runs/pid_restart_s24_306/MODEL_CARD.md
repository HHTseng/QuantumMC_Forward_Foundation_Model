...
- Residual negative log likelihood (standardized coordinates): -5.350018
- Reconstructed-PID cross entropy: 0.983935
- Reconstructed-PID top-1 accuracy: 67.8439%
- PID maximum marginal probability discrepancy: 0.1647%
- Worst fixed-bin conditional PID total-variation distance: 0.0251 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1172%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1624%

One-dimensional sampled closure:

- pi- delta_p: W1=0.0089008, mean difference=0.0012541, std ratio=1.0022
- pi- delta_theta: W1=0.0010645, mean difference=0.0006772, std ratio=0.9829
- pi- delta_phi: W1=0.016044, mean difference=0.0028757, std ratio=0.9590
- pi+ delta_p: W1=0.018202, mean difference=0.014964, std ratio=1.0170
- pi+ delta_theta: W1=0.00081238, mean difference=9.0089e-05, std ratio=1.0172
- pi+ delta_phi: W1=0.01304, mean difference=0.0026045, std ratio=1.0023
- proton delta_p: W1=0.012156, mean difference=0.010104, std ratio=1.0162
- proton delta_theta: W1=0.00065323, mean difference=0.000161, std ratio=1.0059
- proton delta_phi: W1=0.007722, mean difference=8.4547e-05, std ratio=1.0205
