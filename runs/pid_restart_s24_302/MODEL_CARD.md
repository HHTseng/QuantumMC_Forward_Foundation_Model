...
- Residual negative log likelihood (standardized coordinates): -5.347390
- Reconstructed-PID cross entropy: 0.983923
- Reconstructed-PID top-1 accuracy: 67.8477%
- PID maximum marginal probability discrepancy: 0.2064%
- Worst fixed-bin conditional PID total-variation distance: 0.0235 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1040%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1266%

One-dimensional sampled closure:

- pi- delta_p: W1=0.013861, mean difference=0.010287, std ratio=0.9993
- pi- delta_theta: W1=0.0014989, mean difference=0.00072744, std ratio=0.9882
- pi- delta_phi: W1=0.016424, mean difference=0.0047897, std ratio=0.9638
- pi+ delta_p: W1=0.02375, mean difference=0.019198, std ratio=1.0192
- pi+ delta_theta: W1=0.00093433, mean difference=3.2312e-06, std ratio=1.0109
- pi+ delta_phi: W1=0.012557, mean difference=0.0013796, std ratio=1.0166
- proton delta_p: W1=0.0097333, mean difference=0.0058158, std ratio=0.9931
- proton delta_theta: W1=0.00050335, mean difference=2.2477e-05, std ratio=0.9979
- proton delta_phi: W1=0.0088444, mean difference=0.00050575, std ratio=1.0262
