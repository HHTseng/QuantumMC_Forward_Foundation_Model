...
- Residual negative log likelihood (standardized coordinates): -5.335819
- Reconstructed-PID cross entropy: 0.979653
- Reconstructed-PID top-1 accuracy: 67.9548%
- PID maximum marginal probability discrepancy: 0.1152%
- Worst fixed-bin conditional PID total-variation distance: 0.0220 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0850%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1021%

One-dimensional sampled closure:

- pi- delta_p: W1=0.013737, mean difference=0.0016028, std ratio=1.0012
- pi- delta_theta: W1=0.0019629, mean difference=0.00049439, std ratio=1.0228
- pi- delta_phi: W1=0.015685, mean difference=0.0024507, std ratio=0.9751
- pi+ delta_p: W1=0.012152, mean difference=0.0034546, std ratio=1.0128
- pi+ delta_theta: W1=0.0010724, mean difference=0.00018704, std ratio=1.0113
- pi+ delta_phi: W1=0.01213, mean difference=0.002156, std ratio=0.9914
- proton delta_p: W1=0.0090085, mean difference=0.0040532, std ratio=0.9993
- proton delta_theta: W1=0.00064932, mean difference=4.947e-05, std ratio=1.0149
- proton delta_phi: W1=0.0082162, mean difference=1.2016e-05, std ratio=0.9811
