...
- Residual negative log likelihood (standardized coordinates): -5.332952
- Reconstructed-PID cross entropy: 0.979685
- Reconstructed-PID top-1 accuracy: 67.9574%
- PID maximum marginal probability discrepancy: 0.1072%
- Worst fixed-bin conditional PID total-variation distance: 0.0256 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 98.9954%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.2214%

One-dimensional sampled closure:

- pi- delta_p: W1=0.016915, mean difference=0.013132, std ratio=1.0112
- pi- delta_theta: W1=0.0011495, mean difference=0.00035128, std ratio=0.9999
- pi- delta_phi: W1=0.0076096, mean difference=0.0032698, std ratio=0.9852
- pi+ delta_p: W1=0.016964, mean difference=0.010962, std ratio=1.0139
- pi+ delta_theta: W1=0.0011182, mean difference=3.6133e-05, std ratio=1.0181
- pi+ delta_phi: W1=0.010109, mean difference=0.0016883, std ratio=0.9906
- proton delta_p: W1=0.010301, mean difference=0.0044563, std ratio=1.0012
- proton delta_theta: W1=0.0010322, mean difference=0.00082306, std ratio=1.0005
- proton delta_phi: W1=0.0079071, mean difference=0.0052185, std ratio=0.9830
