...
- Residual negative log likelihood (standardized coordinates): -5.371134
- Reconstructed-PID cross entropy: 0.979465
- Reconstructed-PID top-1 accuracy: 67.9579%
- PID maximum marginal probability discrepancy: 0.5023%
- Worst fixed-bin conditional PID total-variation distance: 0.0286 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1070%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.0962%

One-dimensional sampled closure:

- pi- delta_p: W1=0.018342, mean difference=0.00077081, std ratio=1.0113
- pi- delta_theta: W1=0.0010298, mean difference=0.00023763, std ratio=0.9988
- pi- delta_phi: W1=0.016321, mean difference=0.00091944, std ratio=0.9455
- pi+ delta_p: W1=0.010255, mean difference=0.0029712, std ratio=1.0112
- pi+ delta_theta: W1=0.00082546, mean difference=4.317e-05, std ratio=0.9920
- pi+ delta_phi: W1=0.011922, mean difference=0.0026798, std ratio=0.9890
- proton delta_p: W1=0.0063737, mean difference=0.002427, std ratio=1.0039
- proton delta_theta: W1=0.00063415, mean difference=0.00025003, std ratio=0.9960
- proton delta_phi: W1=0.007689, mean difference=0.0002386, std ratio=1.0094
