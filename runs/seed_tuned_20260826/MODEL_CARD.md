...
- Residual negative log likelihood (standardized coordinates): -5.262904
- Reconstructed-PID cross entropy: 0.981706
- Reconstructed-PID top-1 accuracy: 67.9218%
- PID maximum marginal probability discrepancy: 0.1358%
- Worst fixed-bin conditional PID total-variation distance: 0.0303 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1396%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.2254%

One-dimensional sampled closure:

- pi- delta_p: W1=0.015936, mean difference=0.0026093, std ratio=1.0125
- pi- delta_theta: W1=0.0012067, mean difference=9.0515e-05, std ratio=0.9792
- pi- delta_phi: W1=0.019981, mean difference=0.011744, std ratio=0.9437
- pi+ delta_p: W1=0.0094897, mean difference=0.004645, std ratio=1.0078
- pi+ delta_theta: W1=0.0013177, mean difference=0.0010595, std ratio=0.9915
- pi+ delta_phi: W1=0.0089858, mean difference=0.0055872, std ratio=0.9203
- proton delta_p: W1=0.0088695, mean difference=0.0026176, std ratio=0.9937
- proton delta_theta: W1=0.001042, mean difference=7.0722e-05, std ratio=0.9782
- proton delta_phi: W1=0.0032427, mean difference=0.00080354, std ratio=0.9874
