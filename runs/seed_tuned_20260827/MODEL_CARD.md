...
- Residual negative log likelihood (standardized coordinates): -5.341440
- Reconstructed-PID cross entropy: 0.977335
- Reconstructed-PID top-1 accuracy: 68.1594%
- PID maximum marginal probability discrepancy: 0.2133%
- Worst fixed-bin conditional PID total-variation distance: 0.0379 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0552%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1393%

One-dimensional sampled closure:

- pi- delta_p: W1=0.012137, mean difference=0.0012403, std ratio=1.0015
- pi- delta_theta: W1=0.0016827, mean difference=0.00043437, std ratio=1.0094
- pi- delta_phi: W1=0.019276, mean difference=0.0044803, std ratio=0.9531
- pi+ delta_p: W1=0.014489, mean difference=0.0074288, std ratio=1.0116
- pi+ delta_theta: W1=0.00082431, mean difference=0.00029073, std ratio=1.0139
- pi+ delta_phi: W1=0.011913, mean difference=0.001804, std ratio=0.9976
- proton delta_p: W1=0.011884, mean difference=0.0096052, std ratio=1.0162
- proton delta_theta: W1=0.00052408, mean difference=0.00020675, std ratio=1.0007
- proton delta_phi: W1=0.0098016, mean difference=0.0026028, std ratio=1.0171
