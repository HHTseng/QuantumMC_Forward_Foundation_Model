...
- Residual negative log likelihood (standardized coordinates): -5.203531
- Reconstructed-PID cross entropy: 0.983922
- Reconstructed-PID top-1 accuracy: 67.8515%
- PID maximum marginal probability discrepancy: 0.1440%
- Worst fixed-bin conditional PID total-variation distance: 0.0263 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0783%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.0475%

One-dimensional sampled closure:

- pi- delta_p: W1=0.026002, mean difference=0.018255, std ratio=1.0147
- pi- delta_theta: W1=0.0017138, mean difference=0.0014031, std ratio=0.9866
- pi- delta_phi: W1=0.02068, mean difference=0.0067303, std ratio=0.9563
- pi+ delta_p: W1=0.017283, mean difference=0.011076, std ratio=1.0132
- pi+ delta_theta: W1=0.00065399, mean difference=0.00015643, std ratio=1.0067
- pi+ delta_phi: W1=0.013006, mean difference=0.00051334, std ratio=0.9969
- proton delta_p: W1=0.036815, mean difference=0.031006, std ratio=1.0318
- proton delta_theta: W1=0.0015635, mean difference=0.00046001, std ratio=1.0250
- proton delta_phi: W1=0.013929, mean difference=0.00045797, std ratio=1.0561
