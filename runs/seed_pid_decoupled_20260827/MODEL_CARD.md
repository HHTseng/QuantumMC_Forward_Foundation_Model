...
- Residual negative log likelihood (standardized coordinates): -5.229814
- Reconstructed-PID cross entropy: 0.976925
- Reconstructed-PID top-1 accuracy: 68.1544%
- PID maximum marginal probability discrepancy: 0.3689%
- Worst fixed-bin conditional PID total-variation distance: 0.0339 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1556%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1091%

One-dimensional sampled closure:

- pi- delta_p: W1=0.025178, mean difference=0.0097933, std ratio=1.0064
- pi- delta_theta: W1=0.0016661, mean difference=0.00074002, std ratio=1.0184
- pi- delta_phi: W1=0.019147, mean difference=0.0029774, std ratio=0.9414
- pi+ delta_p: W1=0.01725, mean difference=0.0030077, std ratio=0.9917
- pi+ delta_theta: W1=0.0010374, mean difference=0.00018378, std ratio=1.0166
- pi+ delta_phi: W1=0.0051845, mean difference=0.001029, std ratio=0.9910
- proton delta_p: W1=0.012376, mean difference=0.0090275, std ratio=0.9920
- proton delta_theta: W1=0.00054725, mean difference=0.00017303, std ratio=1.0119
- proton delta_phi: W1=0.0056182, mean difference=0.0028246, std ratio=0.9840
