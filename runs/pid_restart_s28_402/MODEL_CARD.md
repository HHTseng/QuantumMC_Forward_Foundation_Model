...
- Residual negative log likelihood (standardized coordinates): -5.315192
- Reconstructed-PID cross entropy: 0.979709
- Reconstructed-PID top-1 accuracy: 67.9492%
- PID maximum marginal probability discrepancy: 0.0996%
- Worst fixed-bin conditional PID total-variation distance: 0.0260 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1059%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.2726%

One-dimensional sampled closure:

- pi- delta_p: W1=0.018574, mean difference=0.011915, std ratio=0.9873
- pi- delta_theta: W1=0.0010027, mean difference=0.00062575, std ratio=0.9962
- pi- delta_phi: W1=0.010646, mean difference=0.0020077, std ratio=0.9596
- pi+ delta_p: W1=0.011145, mean difference=0.00047076, std ratio=0.9995
- pi+ delta_theta: W1=0.0011287, mean difference=0.00041842, std ratio=1.0026
- pi+ delta_phi: W1=0.0065183, mean difference=0.00080756, std ratio=0.9827
- proton delta_p: W1=0.0093051, mean difference=0.0056553, std ratio=0.9935
- proton delta_theta: W1=0.00078154, mean difference=0.00036059, std ratio=1.0005
- proton delta_phi: W1=0.0057007, mean difference=0.0029994, std ratio=0.9680
