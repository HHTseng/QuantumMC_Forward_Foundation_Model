...
- Residual negative log likelihood (standardized coordinates): -5.338543
- Reconstructed-PID cross entropy: 0.979829
- Reconstructed-PID top-1 accuracy: 67.9341%
- PID maximum marginal probability discrepancy: 0.1286%
- Worst fixed-bin conditional PID total-variation distance: 0.0460 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0641%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1584%

One-dimensional sampled closure:

- pi- delta_p: W1=0.0093058, mean difference=0.0033146, std ratio=1.0055
- pi- delta_theta: W1=0.0011176, mean difference=0.00032372, std ratio=0.9842
- pi- delta_phi: W1=0.017683, mean difference=0.0038683, std ratio=0.9549
- pi+ delta_p: W1=0.029923, mean difference=0.019788, std ratio=0.9677
- pi+ delta_theta: W1=0.0011487, mean difference=0.0001125, std ratio=0.9871
- pi+ delta_phi: W1=0.0082907, mean difference=0.00056625, std ratio=0.9015
- proton delta_p: W1=0.0086152, mean difference=0.0033063, std ratio=0.9982
- proton delta_theta: W1=0.00092827, mean difference=0.00014989, std ratio=0.9873
- proton delta_phi: W1=0.007549, mean difference=0.001605, std ratio=1.0070
