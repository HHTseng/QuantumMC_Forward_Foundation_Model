...
- Residual negative log likelihood (standardized coordinates): -5.705374
- Reconstructed-PID cross entropy: 0.722810
- Reconstructed-PID top-1 accuracy: 73.8867%
- PID maximum marginal probability discrepancy: 0.3098%
- Worst fixed-bin conditional PID total-variation distance: 0.0249 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0760%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1543%

One-dimensional sampled closure:

- pi- delta_p: W1=0.017184, mean difference=0.010234, std ratio=1.0022
- pi- delta_theta: W1=0.00099086, mean difference=0.00051375, std ratio=1.0038
- pi- delta_phi: W1=0.014684, mean difference=0.0040283, std ratio=0.9727
- pi+ delta_p: W1=0.012261, mean difference=0.0039263, std ratio=1.0083
- pi+ delta_theta: W1=0.0010092, mean difference=0.00046264, std ratio=1.0039
- pi+ delta_phi: W1=0.013069, mean difference=0.0021453, std ratio=0.9982
- proton delta_p: W1=0.012845, mean difference=0.011258, std ratio=0.9899
- proton delta_theta: W1=0.00064047, mean difference=0.00030437, std ratio=0.9950
- proton delta_phi: W1=0.0083221, mean difference=0.0016352, std ratio=1.0003
