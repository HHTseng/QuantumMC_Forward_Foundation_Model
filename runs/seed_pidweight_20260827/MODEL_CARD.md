...
- Residual negative log likelihood (standardized coordinates): -5.235464
- Reconstructed-PID cross entropy: 0.976360
- Reconstructed-PID top-1 accuracy: 68.1631%
- PID maximum marginal probability discrepancy: 0.1699%
- Worst fixed-bin conditional PID total-variation distance: 0.0340 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0590%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.0320%

One-dimensional sampled closure:

- pi- delta_p: W1=0.054926, mean difference=0.046782, std ratio=1.0151
- pi- delta_theta: W1=0.0029044, mean difference=0.00033465, std ratio=1.0198
- pi- delta_phi: W1=0.019509, mean difference=5.2353e-05, std ratio=0.9709
- pi+ delta_p: W1=0.0098722, mean difference=0.0012873, std ratio=1.0037
- pi+ delta_theta: W1=0.0008516, mean difference=0.00018111, std ratio=1.0053
- pi+ delta_phi: W1=0.0096486, mean difference=0.0019994, std ratio=0.9814
- proton delta_p: W1=0.0076734, mean difference=0.0029579, std ratio=1.0046
- proton delta_theta: W1=0.00067506, mean difference=0.00018575, std ratio=0.9922
- proton delta_phi: W1=0.0070601, mean difference=0.0018495, std ratio=0.9969
