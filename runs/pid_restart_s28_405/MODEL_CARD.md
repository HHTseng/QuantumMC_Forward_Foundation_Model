...
- Residual negative log likelihood (standardized coordinates): -5.668189
- Reconstructed-PID cross entropy: 0.721736
- Reconstructed-PID top-1 accuracy: 74.0023%
- PID maximum marginal probability discrepancy: 0.2987%
- Worst fixed-bin conditional PID total-variation distance: 0.0234 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1078%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1204%

One-dimensional sampled closure:

- pi- delta_p: W1=0.019579, mean difference=0.012235, std ratio=0.9888
- pi- delta_theta: W1=0.0016533, mean difference=0.00091859, std ratio=1.0010
- pi- delta_phi: W1=0.01161, mean difference=0.00037313, std ratio=0.9555
- pi+ delta_p: W1=0.015206, mean difference=0.0068663, std ratio=0.9990
- pi+ delta_theta: W1=0.00086824, mean difference=0.00011312, std ratio=0.9989
- pi+ delta_phi: W1=0.010345, mean difference=0.0021786, std ratio=0.9801
- proton delta_p: W1=0.0087872, mean difference=0.0053754, std ratio=0.9989
- proton delta_theta: W1=0.00077742, mean difference=0.00012516, std ratio=0.9934
- proton delta_phi: W1=0.0063662, mean difference=0.0029489, std ratio=0.9571
