...
- Residual negative log likelihood (standardized coordinates): -5.292126
- Reconstructed-PID cross entropy: 0.985305
- Reconstructed-PID top-1 accuracy: 67.8527%
- PID maximum marginal probability discrepancy: 0.1913%
- Worst fixed-bin conditional PID total-variation distance: 0.0291 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1630%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.2773%

One-dimensional sampled closure:

- pi- delta_p: W1=0.012718, mean difference=0.0074474, std ratio=1.0056
- pi- delta_theta: W1=0.0011315, mean difference=0.00099337, std ratio=0.9929
- pi- delta_phi: W1=0.015819, mean difference=0.0036497, std ratio=0.9439
- pi+ delta_p: W1=0.018606, mean difference=0.015131, std ratio=1.0173
- pi+ delta_theta: W1=0.0010692, mean difference=0.0002957, std ratio=1.0247
- pi+ delta_phi: W1=0.0053622, mean difference=0.0017839, std ratio=0.9893
- proton delta_p: W1=0.0078415, mean difference=0.0024175, std ratio=0.9987
- proton delta_theta: W1=0.00080675, mean difference=0.00040885, std ratio=1.0171
- proton delta_phi: W1=0.0052667, mean difference=0.001999, std ratio=1.0219
