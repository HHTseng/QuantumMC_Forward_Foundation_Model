...
- Residual negative log likelihood (standardized coordinates): -5.364867
- Reconstructed-PID cross entropy: 0.977799
- Reconstructed-PID top-1 accuracy: 67.9725%
- PID maximum marginal probability discrepancy: 0.0715%
- Worst fixed-bin conditional PID total-variation distance: 0.0288 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1499%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1436%

One-dimensional sampled closure:

- pi- delta_p: W1=0.0079892, mean difference=0.00362, std ratio=0.9996
- pi- delta_theta: W1=0.0012477, mean difference=0.00016634, std ratio=1.0072
- pi- delta_phi: W1=0.019109, mean difference=0.010679, std ratio=0.9697
- pi+ delta_p: W1=0.013822, mean difference=0.0075719, std ratio=1.0143
- pi+ delta_theta: W1=0.00083023, mean difference=0.00013298, std ratio=0.9984
- pi+ delta_phi: W1=0.012511, mean difference=0.0053793, std ratio=0.9793
- proton delta_p: W1=0.0078931, mean difference=0.0016331, std ratio=1.0084
- proton delta_theta: W1=0.00079908, mean difference=0.00018186, std ratio=1.0106
- proton delta_phi: W1=0.0088181, mean difference=0.0026464, std ratio=1.0068
