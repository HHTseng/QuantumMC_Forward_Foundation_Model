...
- Residual negative log likelihood (standardized coordinates): -5.667140
- Reconstructed-PID cross entropy: 0.728621
- Reconstructed-PID top-1 accuracy: 73.6530%
- PID maximum marginal probability discrepancy: 0.3134%
- Worst fixed-bin conditional PID total-variation distance: 0.0277 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0142%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.0350%

One-dimensional sampled closure:

- pi- delta_p: W1=0.017916, mean difference=0.0073053, std ratio=1.0065
- pi- delta_theta: W1=0.0013692, mean difference=0.0010296, std ratio=0.9986
- pi- delta_phi: W1=0.01561, mean difference=0.0051274, std ratio=0.9588
- pi+ delta_p: W1=0.0089309, mean difference=0.00023711, std ratio=1.0040
- pi+ delta_theta: W1=0.00083194, mean difference=0.00042021, std ratio=1.0042
- pi+ delta_phi: W1=0.0058439, mean difference=0.00088459, std ratio=1.0006
- proton delta_p: W1=0.014729, mean difference=0.009478, std ratio=0.9861
- proton delta_theta: W1=0.00089684, mean difference=0.00020664, std ratio=1.0126
- proton delta_phi: W1=0.0096248, mean difference=0.001387, std ratio=1.0215
