...
- Residual negative log likelihood (standardized coordinates): -5.347201
- Reconstructed-PID cross entropy: 0.979507
- Reconstructed-PID top-1 accuracy: 67.9662%
- PID maximum marginal probability discrepancy: 0.1317%
- Worst fixed-bin conditional PID total-variation distance: 0.0249 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1349%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1280%

One-dimensional sampled closure:

- pi- delta_p: W1=0.017839, mean difference=0.013486, std ratio=1.0178
- pi- delta_theta: W1=0.0012625, mean difference=0.00036411, std ratio=1.0038
- pi- delta_phi: W1=0.012135, mean difference=0.0056903, std ratio=0.9712
- pi+ delta_p: W1=0.012605, mean difference=0.00097787, std ratio=1.0084
- pi+ delta_theta: W1=0.00087261, mean difference=3.7747e-05, std ratio=1.0001
- pi+ delta_phi: W1=0.010185, mean difference=0.00069236, std ratio=0.9945
- proton delta_p: W1=0.0097668, mean difference=0.0037694, std ratio=1.0052
- proton delta_theta: W1=0.00084753, mean difference=0.00012933, std ratio=0.9980
- proton delta_phi: W1=0.0085736, mean difference=0.0026967, std ratio=0.9937
