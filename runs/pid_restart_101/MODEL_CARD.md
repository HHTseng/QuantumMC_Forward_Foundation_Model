...
- Residual negative log likelihood (standardized coordinates): -5.640824
- Reconstructed-PID cross entropy: 0.726967
- Reconstructed-PID top-1 accuracy: 73.6912%
- PID maximum marginal probability discrepancy: 0.3609%
- Worst fixed-bin conditional PID total-variation distance: 0.0368 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1024%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.0861%

One-dimensional sampled closure:

- pi- delta_p: W1=0.023876, mean difference=0.019888, std ratio=0.9929
- pi- delta_theta: W1=0.0010825, mean difference=0.0001707, std ratio=0.9942
- pi- delta_phi: W1=0.016116, mean difference=0.0020843, std ratio=0.9531
- pi+ delta_p: W1=0.018122, mean difference=0.010932, std ratio=0.9956
- pi+ delta_theta: W1=0.0008166, mean difference=0.00023812, std ratio=0.9952
- pi+ delta_phi: W1=0.011902, mean difference=0.0024482, std ratio=0.9769
- proton delta_p: W1=0.022967, mean difference=0.018828, std ratio=0.9736
- proton delta_theta: W1=0.0011075, mean difference=0.00057533, std ratio=0.9909
- proton delta_phi: W1=0.0082947, mean difference=0.0011386, std ratio=0.9822
