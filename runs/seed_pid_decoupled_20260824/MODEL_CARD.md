...
- Residual negative log likelihood (standardized coordinates): -5.343832
- Reconstructed-PID cross entropy: 0.984286
- Reconstructed-PID top-1 accuracy: 67.8496%
- PID maximum marginal probability discrepancy: 0.2468%
- Worst fixed-bin conditional PID total-variation distance: 0.0296 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0638%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1442%

One-dimensional sampled closure:

- pi- delta_p: W1=0.018271, mean difference=0.0020562, std ratio=1.0095
- pi- delta_theta: W1=0.0015102, mean difference=0.0011147, std ratio=1.0005
- pi- delta_phi: W1=0.016337, mean difference=0.0027098, std ratio=0.9445
- pi+ delta_p: W1=0.024251, mean difference=0.020669, std ratio=1.0242
- pi+ delta_theta: W1=0.0011549, mean difference=0.00077934, std ratio=1.0218
- pi+ delta_phi: W1=0.0090088, mean difference=0.0042144, std ratio=0.9752
- proton delta_p: W1=0.010385, mean difference=0.0025845, std ratio=0.9985
- proton delta_theta: W1=0.0013396, mean difference=0.0011479, std ratio=1.0169
- proton delta_phi: W1=0.0067118, mean difference=0.0036633, std ratio=1.0130
