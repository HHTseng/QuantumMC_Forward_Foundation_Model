...
- Residual negative log likelihood (standardized coordinates): -5.328312
- Reconstructed-PID cross entropy: 0.980738
- Reconstructed-PID top-1 accuracy: 67.9274%
- PID maximum marginal probability discrepancy: 0.1867%
- Worst fixed-bin conditional PID total-variation distance: 0.0296 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1353%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1830%

One-dimensional sampled closure:

- pi- delta_p: W1=0.019356, mean difference=0.013909, std ratio=0.9982
- pi- delta_theta: W1=0.00086938, mean difference=0.00019822, std ratio=1.0113
- pi- delta_phi: W1=0.015672, mean difference=0.0044106, std ratio=0.9479
- pi+ delta_p: W1=0.030061, mean difference=0.023958, std ratio=0.9887
- pi+ delta_theta: W1=0.0011004, mean difference=0.000744, std ratio=0.9956
- pi+ delta_phi: W1=0.010719, mean difference=0.0009655, std ratio=0.9825
- proton delta_p: W1=0.0083297, mean difference=0.006351, std ratio=0.9968
- proton delta_theta: W1=0.00086216, mean difference=0.00059204, std ratio=0.9925
- proton delta_phi: W1=0.0076219, mean difference=0.00027765, std ratio=0.9956
