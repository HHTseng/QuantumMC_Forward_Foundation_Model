...
- Residual negative log likelihood (standardized coordinates): -5.376376
- Reconstructed-PID cross entropy: 0.979203
- Reconstructed-PID top-1 accuracy: 67.9655%
- PID maximum marginal probability discrepancy: 0.0642%
- Worst fixed-bin conditional PID total-variation distance: 0.0287 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0975%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1985%

One-dimensional sampled closure:

- pi- delta_p: W1=0.017099, mean difference=0.0081323, std ratio=1.0137
- pi- delta_theta: W1=0.0011935, mean difference=0.00024931, std ratio=1.0036
- pi- delta_phi: W1=0.016936, mean difference=0.0013631, std ratio=0.9433
- pi+ delta_p: W1=0.015089, mean difference=0.010222, std ratio=1.0154
- pi+ delta_theta: W1=0.0010319, mean difference=0.00021544, std ratio=1.0080
- pi+ delta_phi: W1=0.012667, mean difference=0.0024187, std ratio=1.0015
- proton delta_p: W1=0.0071368, mean difference=0.0025516, std ratio=1.0012
- proton delta_theta: W1=0.00069612, mean difference=0.00010142, std ratio=1.0088
- proton delta_phi: W1=0.0084812, mean difference=7.4756e-05, std ratio=1.0162
