...
- Residual negative log likelihood (standardized coordinates): -5.335401
- Reconstructed-PID cross entropy: 0.981168
- Reconstructed-PID top-1 accuracy: 67.9262%
- PID maximum marginal probability discrepancy: 0.3909%
- Worst fixed-bin conditional PID total-variation distance: 0.0319 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0555%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1277%

One-dimensional sampled closure:

- pi- delta_p: W1=0.031173, mean difference=0.015652, std ratio=1.0078
- pi- delta_theta: W1=0.0012662, mean difference=9.7801e-05, std ratio=1.0267
- pi- delta_phi: W1=0.015324, mean difference=0.0030913, std ratio=0.9643
- pi+ delta_p: W1=0.022434, mean difference=0.012999, std ratio=1.0289
- pi+ delta_theta: W1=0.0011201, mean difference=0.00049903, std ratio=1.0151
- pi+ delta_phi: W1=0.012795, mean difference=0.0011208, std ratio=1.0094
- proton delta_p: W1=0.0081075, mean difference=0.0010039, std ratio=1.0113
- proton delta_theta: W1=0.00059167, mean difference=0.00019047, std ratio=1.0070
- proton delta_phi: W1=0.0074411, mean difference=0.00080189, std ratio=1.0180
