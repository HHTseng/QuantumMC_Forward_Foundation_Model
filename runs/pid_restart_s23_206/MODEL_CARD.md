...
- Residual negative log likelihood (standardized coordinates): -5.336985
- Reconstructed-PID cross entropy: 0.977985
- Reconstructed-PID top-1 accuracy: 67.9781%
- PID maximum marginal probability discrepancy: 0.1042%
- Worst fixed-bin conditional PID total-variation distance: 0.0243 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0508%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1644%

One-dimensional sampled closure:

- pi- delta_p: W1=0.012474, mean difference=0.0094897, std ratio=0.9921
- pi- delta_theta: W1=0.0012902, mean difference=0.00048523, std ratio=1.0079
- pi- delta_phi: W1=0.012118, mean difference=0.0037123, std ratio=0.9880
- pi+ delta_p: W1=0.015248, mean difference=0.0083016, std ratio=1.0147
- pi+ delta_theta: W1=0.00076425, mean difference=1.9194e-05, std ratio=1.0004
- pi+ delta_phi: W1=0.0094634, mean difference=0.00027876, std ratio=0.9787
- proton delta_p: W1=0.014593, mean difference=0.010884, std ratio=1.0178
- proton delta_theta: W1=0.001044, mean difference=0.00020317, std ratio=1.0247
- proton delta_phi: W1=0.0090964, mean difference=0.0032777, std ratio=1.0187
