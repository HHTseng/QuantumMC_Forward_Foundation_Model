...
- Residual negative log likelihood (standardized coordinates): -4.706893
- Reconstructed-PID cross entropy: 1.018266
- Reconstructed-PID top-1 accuracy: 67.5507%
- PID maximum marginal probability discrepancy: 0.4380%
- Worst fixed-bin conditional PID total-variation distance: 0.0676 (proton, 6-7 GeV)
- Physical sampled `(p, theta)` fraction: 98.2985%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 98.1760%

One-dimensional sampled closure:

- pi- delta_p: W1=0.032743, mean difference=0.0043015, std ratio=0.9884
- pi- delta_theta: W1=0.003137, mean difference=0.00049677, std ratio=0.9723
- pi- delta_phi: W1=0.021261, mean difference=0.010238, std ratio=0.9374
- pi+ delta_p: W1=0.057558, mean difference=0.02198, std ratio=1.0049
- pi+ delta_theta: W1=0.0024671, mean difference=0.00013461, std ratio=0.9623
- pi+ delta_phi: W1=0.011711, mean difference=0.0047504, std ratio=0.9745
- proton delta_p: W1=0.030823, mean difference=0.018764, std ratio=1.0085
- proton delta_theta: W1=0.0018815, mean difference=0.00056923, std ratio=0.9917
- proton delta_phi: W1=0.016754, mean difference=0.00045849, std ratio=1.0611
