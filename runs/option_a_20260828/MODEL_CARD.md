...
- Residual negative log likelihood (standardized coordinates): -5.340680
- Reconstructed-PID cross entropy: 0.980611
- Reconstructed-PID top-1 accuracy: 67.9713%
- PID maximum marginal probability discrepancy: 0.1150%
- Worst fixed-bin conditional PID total-variation distance: 0.0275 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0452%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1444%

One-dimensional sampled closure:

- pi- delta_p: W1=0.019493, mean difference=0.013889, std ratio=1.0167
- pi- delta_theta: W1=0.0011179, mean difference=0.00038731, std ratio=1.0002
- pi- delta_phi: W1=0.017027, mean difference=0.008339, std ratio=0.9623
- pi+ delta_p: W1=0.020844, mean difference=0.014875, std ratio=1.0174
- pi+ delta_theta: W1=0.0012194, mean difference=4.7305e-05, std ratio=1.0158
- pi+ delta_phi: W1=0.014519, mean difference=0.0016134, std ratio=1.0026
- proton delta_p: W1=0.0083876, mean difference=0.0032792, std ratio=1.0139
- proton delta_theta: W1=0.0006476, mean difference=0.00038863, std ratio=1.0073
- proton delta_phi: W1=0.0081891, mean difference=0.0022573, std ratio=1.0046
