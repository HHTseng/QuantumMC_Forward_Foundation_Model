...
- Residual negative log likelihood (standardized coordinates): -5.662231
- Reconstructed-PID cross entropy: 0.720774
- Reconstructed-PID top-1 accuracy: 73.9516%
- PID maximum marginal probability discrepancy: 0.2771%
- Worst fixed-bin conditional PID total-variation distance: 0.0358 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1144%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1496%

One-dimensional sampled closure:

- pi- delta_p: W1=0.015429, mean difference=0.0059924, std ratio=1.0039
- pi- delta_theta: W1=0.0010085, mean difference=0.00069557, std ratio=1.0006
- pi- delta_phi: W1=0.010987, mean difference=0.0022322, std ratio=0.9610
- pi+ delta_p: W1=0.0093031, mean difference=0.00011832, std ratio=1.0074
- pi+ delta_theta: W1=0.00086938, mean difference=2.344e-05, std ratio=1.0045
- pi+ delta_phi: W1=0.0049843, mean difference=0.0028107, std ratio=0.9690
- proton delta_p: W1=0.009008, mean difference=0.0034839, std ratio=0.9966
- proton delta_theta: W1=0.00077924, mean difference=0.00038575, std ratio=1.0054
- proton delta_phi: W1=0.0042056, mean difference=9.2867e-05, std ratio=0.9985
