...
- Residual negative log likelihood (standardized coordinates): -5.326194
- Reconstructed-PID cross entropy: 0.980693
- Reconstructed-PID top-1 accuracy: 67.9243%
- PID maximum marginal probability discrepancy: 0.1482%
- Worst fixed-bin conditional PID total-variation distance: 0.0299 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0712%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1535%

One-dimensional sampled closure:

- pi- delta_p: W1=0.025553, mean difference=0.017939, std ratio=0.9991
- pi- delta_theta: W1=0.0011647, mean difference=0.00038489, std ratio=1.0021
- pi- delta_phi: W1=0.013794, mean difference=0.0037762, std ratio=0.9601
- pi+ delta_p: W1=0.020543, mean difference=0.014937, std ratio=0.9922
- pi+ delta_theta: W1=0.00099784, mean difference=0.00048606, std ratio=0.9985
- pi+ delta_phi: W1=0.012647, mean difference=0.00050356, std ratio=0.9972
- proton delta_p: W1=0.010743, mean difference=0.0085087, std ratio=0.9901
- proton delta_theta: W1=0.001106, mean difference=0.00080777, std ratio=0.9872
- proton delta_phi: W1=0.0089231, mean difference=0.002497, std ratio=1.0000
