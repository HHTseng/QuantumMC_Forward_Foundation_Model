...
- Residual negative log likelihood (standardized coordinates): -5.358238
- Reconstructed-PID cross entropy: 0.979375
- Reconstructed-PID top-1 accuracy: 67.9366%
- PID maximum marginal probability discrepancy: 0.1417%
- Worst fixed-bin conditional PID total-variation distance: 0.0411 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0924%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1924%

One-dimensional sampled closure:

- pi- delta_p: W1=0.012265, mean difference=0.0076745, std ratio=0.9993
- pi- delta_theta: W1=0.0013658, mean difference=0.00059455, std ratio=0.9954
- pi- delta_phi: W1=0.011157, mean difference=0.0013904, std ratio=0.9513
- pi+ delta_p: W1=0.013664, mean difference=0.0015117, std ratio=1.0046
- pi+ delta_theta: W1=0.0010584, mean difference=0.00045669, std ratio=1.0056
- pi+ delta_phi: W1=0.0072579, mean difference=0.00069515, std ratio=0.9809
- proton delta_p: W1=0.0067694, mean difference=0.0025927, std ratio=1.0063
- proton delta_theta: W1=0.00081821, mean difference=0.00029615, std ratio=1.0047
- proton delta_phi: W1=0.0078279, mean difference=0.00099994, std ratio=0.9918
