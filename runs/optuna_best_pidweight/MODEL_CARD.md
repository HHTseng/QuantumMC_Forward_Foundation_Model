...
- Residual negative log likelihood (standardized coordinates): -5.728556
- Reconstructed-PID cross entropy: 0.719461
- Reconstructed-PID top-1 accuracy: 74.0158%
- PID maximum marginal probability discrepancy: 0.2885%
- Worst fixed-bin conditional PID total-variation distance: 0.0327 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0905%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.0741%

One-dimensional sampled closure:

- pi- delta_p: W1=0.018774, mean difference=0.013007, std ratio=0.9945
- pi- delta_theta: W1=0.001119, mean difference=0.00012394, std ratio=0.9949
- pi- delta_phi: W1=0.013806, mean difference=0.002195, std ratio=0.9580
- pi+ delta_p: W1=0.012229, mean difference=0.0065936, std ratio=0.9955
- pi+ delta_theta: W1=0.00086424, mean difference=7.1324e-05, std ratio=0.9883
- pi+ delta_phi: W1=0.0099126, mean difference=0.0010106, std ratio=0.9858
- proton delta_p: W1=0.0098335, mean difference=0.0017172, std ratio=0.9975
- proton delta_theta: W1=0.00083052, mean difference=0.00024702, std ratio=1.0122
- proton delta_phi: W1=0.0086756, mean difference=0.0010732, std ratio=0.9991
