...
- Residual negative log likelihood (standardized coordinates): -5.367106
- Reconstructed-PID cross entropy: 0.979318
- Reconstructed-PID top-1 accuracy: 67.9404%
- PID maximum marginal probability discrepancy: 0.1641%
- Worst fixed-bin conditional PID total-variation distance: 0.0448 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1031%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1584%

One-dimensional sampled closure:

- pi- delta_p: W1=0.014124, mean difference=0.0061678, std ratio=1.0054
- pi- delta_theta: W1=0.0014861, mean difference=0.0001191, std ratio=0.9868
- pi- delta_phi: W1=0.015426, mean difference=0.0037667, std ratio=0.9428
- pi+ delta_p: W1=0.012685, mean difference=0.003215, std ratio=0.9998
- pi+ delta_theta: W1=0.0014835, mean difference=0.0012438, std ratio=0.9862
- pi+ delta_phi: W1=0.0099613, mean difference=0.0022462, std ratio=0.9610
- proton delta_p: W1=0.0093456, mean difference=0.0011081, std ratio=0.9969
- proton delta_theta: W1=0.0011221, mean difference=0.00080229, std ratio=0.9991
- proton delta_phi: W1=0.0064889, mean difference=0.0016343, std ratio=0.9923
