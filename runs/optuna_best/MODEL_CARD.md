...
- Residual negative log likelihood (standardized coordinates): -5.336459
- Reconstructed-PID cross entropy: 0.980585
- Reconstructed-PID top-1 accuracy: 67.9284%
- PID maximum marginal probability discrepancy: 0.1996%
- Worst fixed-bin conditional PID total-variation distance: 0.0504 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0798%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1219%

One-dimensional sampled closure:

- pi- delta_p: W1=0.010048, mean difference=0.003943, std ratio=1.0075
- pi- delta_theta: W1=0.0011409, mean difference=3.3056e-05, std ratio=0.9855
- pi- delta_phi: W1=0.017673, mean difference=0.0036136, std ratio=0.9516
- pi+ delta_p: W1=0.030408, mean difference=0.022037, std ratio=0.9674
- pi+ delta_theta: W1=0.0012553, mean difference=0.00018417, std ratio=0.9852
- pi+ delta_phi: W1=0.0091804, mean difference=0.00084344, std ratio=0.8912
- proton delta_p: W1=0.011219, mean difference=0.0061283, std ratio=0.9956
- proton delta_theta: W1=0.00093042, mean difference=0.00019882, std ratio=0.9886
- proton delta_phi: W1=0.0074853, mean difference=0.0014425, std ratio=1.0027
