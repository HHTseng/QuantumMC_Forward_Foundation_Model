...
- Residual negative log likelihood (standardized coordinates): -5.364944
- Reconstructed-PID cross entropy: 0.979323
- Reconstructed-PID top-1 accuracy: 67.9435%
- PID maximum marginal probability discrepancy: 0.1724%
- Worst fixed-bin conditional PID total-variation distance: 0.0449 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0402%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1414%

One-dimensional sampled closure:

- pi- delta_p: W1=0.0092002, mean difference=0.0032092, std ratio=0.9971
- pi- delta_theta: W1=0.001144, mean difference=0.00024669, std ratio=0.9893
- pi- delta_phi: W1=0.011117, mean difference=0.00173, std ratio=0.9554
- pi+ delta_p: W1=0.011794, mean difference=0.0035068, std ratio=1.0027
- pi+ delta_theta: W1=0.00096874, mean difference=0.00037039, std ratio=0.9956
- pi+ delta_phi: W1=0.010698, mean difference=0.0038226, std ratio=0.9873
- proton delta_p: W1=0.011429, mean difference=7.8976e-05, std ratio=0.9941
- proton delta_theta: W1=0.00093813, mean difference=0.00048291, std ratio=1.0050
- proton delta_phi: W1=0.0079396, mean difference=0.0011054, std ratio=1.0162
