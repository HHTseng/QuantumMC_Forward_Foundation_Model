...
- Residual negative log likelihood (standardized coordinates): -5.343892
- Reconstructed-PID cross entropy: 0.976707
- Reconstructed-PID top-1 accuracy: 68.1575%
- PID maximum marginal probability discrepancy: 0.1827%
- Worst fixed-bin conditional PID total-variation distance: 0.0365 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0991%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1317%

One-dimensional sampled closure:

- pi- delta_p: W1=0.015746, mean difference=0.0075155, std ratio=0.9972
- pi- delta_theta: W1=0.0014681, mean difference=0.00046613, std ratio=1.0061
- pi- delta_phi: W1=0.019353, mean difference=0.0048588, std ratio=0.9494
- pi+ delta_p: W1=0.010477, mean difference=0.0016713, std ratio=1.0056
- pi+ delta_theta: W1=0.00074608, mean difference=0.0002241, std ratio=1.0135
- pi+ delta_phi: W1=0.011734, mean difference=0.0016805, std ratio=0.9952
- proton delta_p: W1=0.0071426, mean difference=0.0048703, std ratio=1.0094
- proton delta_theta: W1=0.00060011, mean difference=0.00028685, std ratio=0.9992
- proton delta_phi: W1=0.0091986, mean difference=0.0025299, std ratio=1.0098
