...
- Residual negative log likelihood (standardized coordinates): -5.265279
- Reconstructed-PID cross entropy: 0.980902
- Reconstructed-PID top-1 accuracy: 67.9275%
- PID maximum marginal probability discrepancy: 0.2265%
- Worst fixed-bin conditional PID total-variation distance: 0.0327 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0993%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.2373%

One-dimensional sampled closure:

- pi- delta_p: W1=0.015517, mean difference=0.0073127, std ratio=1.0182
- pi- delta_theta: W1=0.0012144, mean difference=0.00010287, std ratio=0.9796
- pi- delta_phi: W1=0.019644, mean difference=0.01167, std ratio=0.9463
- pi+ delta_p: W1=0.011716, mean difference=0.0087662, std ratio=1.0106
- pi+ delta_theta: W1=0.0012279, mean difference=0.0009989, std ratio=0.9959
- pi+ delta_phi: W1=0.0087659, mean difference=0.0059508, std ratio=0.9261
- proton delta_p: W1=0.01013, mean difference=0.0036457, std ratio=1.0016
- proton delta_theta: W1=0.0010782, mean difference=0.00029707, std ratio=0.9886
- proton delta_phi: W1=0.0033031, mean difference=0.00062406, std ratio=0.9942
