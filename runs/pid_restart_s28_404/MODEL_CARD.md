...
- Residual negative log likelihood (standardized coordinates): -5.355068
- Reconstructed-PID cross entropy: 0.979547
- Reconstructed-PID top-1 accuracy: 67.9675%
- PID maximum marginal probability discrepancy: 0.0828%
- Worst fixed-bin conditional PID total-variation distance: 0.0288 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.0074%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.1343%

One-dimensional sampled closure:

- pi- delta_p: W1=0.015847, mean difference=0.013009, std ratio=1.0111
- pi- delta_theta: W1=0.0014509, mean difference=0.00022827, std ratio=1.0109
- pi- delta_phi: W1=0.017202, mean difference=0.0051747, std ratio=0.9595
- pi+ delta_p: W1=0.011165, mean difference=0.0040507, std ratio=1.0056
- pi+ delta_theta: W1=0.0011776, mean difference=0.0002368, std ratio=1.0090
- pi+ delta_phi: W1=0.01447, mean difference=0.0023887, std ratio=1.0070
- proton delta_p: W1=0.0077683, mean difference=0.0028327, std ratio=1.0046
- proton delta_theta: W1=0.00074972, mean difference=0.00019841, std ratio=0.9990
- proton delta_phi: W1=0.0088217, mean difference=0.0007461, std ratio=1.0009
