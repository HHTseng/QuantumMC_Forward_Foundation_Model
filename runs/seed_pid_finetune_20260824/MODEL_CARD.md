...
- Residual negative log likelihood (standardized coordinates): -5.293389
- Reconstructed-PID cross entropy: 0.984420
- Reconstructed-PID top-1 accuracy: 67.8471%
- PID maximum marginal probability discrepancy: 0.1616%
- Worst fixed-bin conditional PID total-variation distance: 0.0272 (pi+, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 99.1530%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 99.2874%

One-dimensional sampled closure:

- pi- delta_p: W1=0.015272, mean difference=0.0094537, std ratio=1.0080
- pi- delta_theta: W1=0.0011438, mean difference=0.0010337, std ratio=0.9938
- pi- delta_phi: W1=0.015361, mean difference=0.003177, std ratio=0.9446
- pi+ delta_p: W1=0.01741, mean difference=0.013647, std ratio=1.0157
- pi+ delta_theta: W1=0.0010379, mean difference=0.00029999, std ratio=1.0229
- pi+ delta_phi: W1=0.0052579, mean difference=0.0013661, std ratio=0.9884
- proton delta_p: W1=0.0082409, mean difference=0.0036774, std ratio=1.0012
- proton delta_theta: W1=0.00081562, mean difference=0.00042272, std ratio=1.0171
- proton delta_phi: W1=0.0052599, mean difference=0.0017466, std ratio=1.0215
