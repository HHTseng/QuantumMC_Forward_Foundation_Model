...
- Best validation epoch: 52

## Held-out test metrics

- Residual negative log likelihood (standardized coordinates): -4.999957
- Reconstructed-PID cross entropy: 0.981682
- Reconstructed-PID top-1 accuracy: 67.9136%
- PID maximum marginal probability discrepancy: 0.3754%
- Worst fixed-bin conditional PID total-variation distance: 0.0343 (pi-, 8-9 GeV)
- Physical sampled `(p, theta)` fraction: 98.8800%
- Sampled reconstructed-theta fraction inside the conditioned 33-degree selection: 98.8762%

One-dimensional sampled closure:

- pi- delta_p: W1=0.040077, mean difference=0.035108, std ratio=1.0198
- pi- delta_theta: W1=0.0016232, mean difference=0.00045216, std ratio=1.0154
- pi- delta_phi: W1=0.016094, mean difference=0.0037988, std ratio=0.9662
- pi+ delta_p: W1=0.08595, mean difference=0.081711, std ratio=1.0508
- pi+ delta_theta: W1=0.0037542, mean difference=0.0020667, std ratio=1.0698
- pi+ delta_phi: W1=0.022539, mean difference=0.0020437, std ratio=1.0456
- proton delta_p: W1=0.05425, mean difference=0.052248, std ratio=1.0348
- proton delta_theta: W1=0.0018963, mean difference=0.00012876, std ratio=1.0322
- proton delta_phi: W1=0.014991, mean difference=0.0023089, std ratio=1.0550
